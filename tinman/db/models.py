...
class ExperimentRunModel(Base):
    ...
    traces = Column(JSONB, nullable=True)
...
class FailureModel(Base):
    ...
    trigger_signature = Column(JSONB, nullable=False, default=list)
    impact_surface = Column(JSONB, nullable=True)
...
class InterventionModel(Base):
    ...
    expected_gains = Column(JSONB, nullable=True)
    expected_regressions = Column(JSONB, nullable=True)
...
class SimulationModel(Base):
    ...
    baseline_metrics = Column(JSONB, nullable=False, default=dict)
    modified_metrics = Column(JSONB, nullable=False, default=dict)
...
class DeploymentModel(Base):
    ...
    mode = Column(String(20), nullable=False)
    rollback_state = Column(JSONB, nullable=True)
